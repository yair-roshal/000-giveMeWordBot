...
const startMenu = {
  keyboard: [
    ...
    [{ text: 'ℹ️ Показать настройки' }, { text: '📚 Выученные слова' }],

    [{ text: '⚙️ Интервал показа слов' }, { text: '🛠️ Сменить время показа' }],

    [{ text: '📚 Настройки словаря' }],

    [{ text: '👥 Все пользователи' }, { text: '🗑️ Очистить кэш мнемоник' }],
