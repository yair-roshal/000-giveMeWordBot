...
Уровень сложности — выведи строку ровно в таком формате, где подходящий вариант обёрнут в <u>...</u>:
A1 🟢 | A2 🟡 | <u>B1 🔵</u> | B2 🟣 | C1 🟠 | C2 🔴
(это пример для B1 — замени на нужный уровень)
...
📝 <b>Стиль:</b> — выведи строку ровно в таком формате, где подходящий вариант обёрнут в <u>...</u>:
👔 Formal | <u>💬 Informal</u> | 📚 Neutral
(это пример для Informal — замени на нужный стиль)

🕰 <b>Актуальность:</b> — выведи строку ровно в таком формате, где подходящий вариант обёрнут в <u>...</u>:
🏺 Obsolete | ⚠️ Limited Use | <u>✅ Current</u>
(это пример для Current — замени на нужный вариант)
