...
📖 <b>{WORD}</b> [МФА-транскрипция в /слешах/] [транскрипция кириллицей] — перевод
— первая транскрипция: международный фонетический алфавит (IPA), например /ˈwɜːrd/
— вторая транскрипция: то же произношение русскими буквами, например (вёрд)
...
💬 <b>Словосочетания:</b>
Три умеренно сложных и часто употребляемых в речи АНГЛИЙСКИХ словосочетания (<i>курсивом</i>), где само слово или выражение всегда <b>жирное</b>.
Перед каждым словосочетанием ставь 2 подходящих эмодзи.
Сразу под английским словосочетанием — его перевод на русский отдельной строкой.

👉 После перевода приводи пример предложения НА АНГЛИЙСКОМ с этим словосочетанием, а следующей строкой — его перевод на русский.
— В английском предложении слово или выражение должно быть <b>жирным</b>.
