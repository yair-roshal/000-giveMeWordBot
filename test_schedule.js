...
console.log('\nОжидаемые времена: 09:00, 11:00, 13:00, 15:00, 17:00, 19:00, 21:00 (7 отправок, без 23:00)')
console.log(`Результат: ${result.length === 7 ? '✅ PASS' : '❌ FAIL'}`)
...
console.log(`Ожидается: 10:00, 11:00, 12:00, 13:00 (4 отправки, без 14:00)`)
console.log(`Результат: ${result2.length === 4 ? '✅ PASS' : '❌ FAIL'}`)
